...
db.users.updateMany(
  ...
  {
    $set: { sector: "Civil Society Organization", subsector: "Non-Government Organization" }
  }
);
...
db.users.updateMany(
  {
    activeRole: "stakeholder",
    name: { $in: ["Federated PTA", "School Alumni", "School Canteen", "HRPTA", "Grade Level PTA", "SPTA", "School Teachers Association"] }
  },
  {
